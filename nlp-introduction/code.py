...
def hyperparameter_optimisation(X_train, y_train):
    ...
    parameters.update({"Random Forest": {
        ...
        "classifier__max_depth": [10, 200, 1000, None],
        "classifier__min_samples_split": [2, 10, 100, None],
        "classifier__min_samples_leaf": [1, 3, 30, None],
        "classifier__criterion": ["gini", "entropy", "log_loss", None],
